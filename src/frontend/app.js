$(document).ready(function(){
    $("#productType").on("change",function(){
        if($("#productType").val() == "dvd" == true){
            ...
            $(".form-dynamic").append("<div class='form-group'><label for='form-furniture-width'>Please enter width of furniture</label><input type='number' name='attribute-width' class='form-control' id='width' placeholder='Width'></div>")
            $(".form-dynamic").append("<div class='form-group'><label for='form-furniture-length'>Please enter length of furniture</label><input type='number' name='attribute-length' class='form-control' id='length' placeholder='Length'></div>")
        }
    })
})
